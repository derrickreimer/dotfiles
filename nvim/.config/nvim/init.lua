...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>rui', function()
            vim.lsp.buf.code_action {
              apply = true,
              context = {
                -- lua_ls doesn't know about TypeScript's extended code actions
                ---@diagnostic disable-next-line: assign-type-mismatch
                only = { 'source.removeUnusedImports' },
                diagnostics = {},
              },
            }
          end, '[R]emove [U]nused [I]mports')
          ...
          local function client_supports_method(client, method, bufnr)
            if vim.fn.has 'nvim-0.11' == 1 then
              ...
              -- Suppress diagnostic warnings for this legacy codepath
          ...
          -- Don't require ENTER when getting LSP notifications
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --           local v = vim.version()
      --           return '⚡ ' .. stats.loaded .. '/' .. stats.count .. ' plugins loaded  |  Neovim v' .. v.major .. '.' .. v.minor .. '.' .. v.patch
      --         end,
      --         content_hooks = {
      ...
      -- Toggle comments with gc (gcc for line, gc in visual mode)
